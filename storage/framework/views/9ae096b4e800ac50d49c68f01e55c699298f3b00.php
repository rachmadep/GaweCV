...
<h4>Biodata Baru</h4>
<form action="<?php echo e(URL::to('biodata/store')); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group <?php echo e($errors->has('foto') ? 'has-error' : ''); ?>">
      ...
      <div class="form-group <?php echo e($errors->has('alamat') ? 'has-error' : ''); ?>">
        ...
        <div class="col-md-9 col-xs-12 input-group">
          <textarea name="alamat" rows="3" class="form-control" cols="80" placeholder="Alamat"></textarea>
